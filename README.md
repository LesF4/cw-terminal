...
Téléchargez `CW_Terminal_Setup_V1.8.exe` depuis la dernière version
Téléchargez aussi le manuel utilisateur PDF (joint à la Release)
Exécuter l'installateur en tant qu'administrateur (clic droit → "Exécuter en tant qu'administrateur")
...
---
🚀 Démarrage rapide
Lancer CW Terminal depuis le raccourci Bureau
Cliquer sur ⚙ Réglages pour saisir indicatif, prénom, QTH, locator, puissance
Choisir l'onglet de connexion correspondant à votre radio (Icom CI-V, Yaesu CAT, OmniRig, FLRig, HRD)
Cliquer sur Connecter — la fréquence s'affiche en vert
Régler le slider Vitesse WF entre 15 et 25 ms selon la vitesse CW
Le décodage CW commence automatiquement
...
Ce dépôt est maintenu par F4MAJ au nom de la communauté Discord Les F4, afin de centraliser les développements logiciels de la communauté.
Site associé : f4maj.fr
Discord : discord.gg/u5Nqpu7ECM
---
